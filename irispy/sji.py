...
class _SJICube(NDCube):
    ...
    def __init__(self, data, wcs, uncertainty=None, unit=None, meta=None,
        ...
        super(_SJICube, self).__init__(data, wcs, uncertainty=uncertainty,
...
def read_iris_sji_level2_fits(filename):
    ...
    return _SJICube(data_nan_masked, wcs, uncertainty=uncertainty, unit=unit,
