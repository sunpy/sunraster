...
def _calculate_orbital_wavelength_variation(
    ...
    g_init = _gaussian1d_on_linear_bg(
        amplitude=-2.0,
...
def calculate_exposure_time_correction(
    old_data_arrays, old_unit, exposure_time, force=False
):
    """
...
def uncalculate_exposure_time_correction(
    old_data_arrays, old_unit, exposure_time, force=False
):
    """
...
def _get_interpolated_effective_area(
    time_obs, response_version, detector_type, obs_wavelength, *args, **kwargs
):
    """
