...
def test_fits_data_comparison(iris_l2_test_raster):
    ...
    np.testing.assert_allclose(iris_l2_test_raster.data[spectral_windows[2]].data, data1)
    np.testing.assert_allclose(iris_l2_test_raster.data[spectral_windows[0]].data, data2)
    np.testing.assert_allclose(iris_l2_test_raster.data[spectral_windows[1]].data, data3)
