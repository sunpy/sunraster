...
If you are unsure of the general features of the RasterPy package, your
...
feedback, or would like help contributing code to RasterPy, you can get
help directly from the RasterPy team in a number of ways.

SunPy Mailing Lists
-------------------

RasterPy is a SunPy-affiliated package and is developed within the
larger SunPy development ecosystem.  You can contact the RasterPy
developers by email via the SunPy mailing lists.  Just reference RasterPy
...
RasterPy works, use the general mailing list. The general mailing list is
another way to get help with doing solar physics in Python. If, on the
other hand, you have a question about the inner workings of RasterPy, 
how RasterPy is organized, or have a question about developing some new
...
your browser. Stop by and say hello. Talk with the SunPy and RasterPy
